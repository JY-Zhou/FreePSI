...
READS=${1}
OUTPUT=output/${1}_Hisat_Cufflinks_Annot_Sampling_${2}
RESULT=result/${1}_Hisat_Cufflinks_Annot_Sampling_${2}
TIME=${RESULT}/time_usage.csv

INDEX_DIR=../data_RefSeq_hg38/annotation/hisat_index
GTF_FILE=./output/${1}_Salmon_Sampling_${2}/hg38_refGene_subset.gtf
